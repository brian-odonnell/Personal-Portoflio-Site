...
var Global = /*#__PURE__*/function () {
  ...
  _createClass(Global, [{
    key: "contactFormSetup",
    value: function contactFormSetup() {
      var popup = document.getElementsByClassName('form__popup')[0];
      var cover = document.getElementsByClassName('form__cover')[0];
      var body = document.body;
      var formTriggers = document.getElementsByClassName('open-form-js');
    ...
    key: "activeNavLinkSetup",
    value: function activeNavLinkSetup() {
      var page = window.location.pathname;
      page = page.substring(1);
      var index = page.search('/');
    ...
    key: "mobileNavControlsSetup",
    value: function mobileNavControlsSetup() {
      var mobileNav = document.getElementsByClassName('mobile-nav-js')[0];
      var body = document.body;
    ...
    key: "swiperSetup",
    value: function swiperSetup() {
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper--photography", {
        navigation: {
          nextEl: ".swiper-button-next",
          prevEl: ".swiper-button-prev"
        },
      ...
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper--work", {
        navigation: {
          nextEl: ".swiper-button-next",
          prevEl: ".swiper-button-prev"
        },
